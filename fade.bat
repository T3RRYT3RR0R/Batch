...
REM Player Sprite movement macros
  		...
  		if !tDiff! geq !delay! (
   			<nul Set /p "=%Sprite[1]%%Sprite[2]%%Sprite[3]%"
    			...
    			For /L %%i in (2 1 !Sprites!)Do (
     				...
     				%= test for collision using Bitshifted Or algorithm assessing the following conditions - effects divide by zero if no condition true =%
